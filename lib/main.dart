...
import 'package:demo_listing/injection_container.dart';
...
import 'package:demo_listing/presentation/pages/landing_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    BlocProvider<ListingBloc>(
      create: (BuildContext context) { 
        return ListingBloc(s1<ListingUsecase>())..add(const FetchList());
